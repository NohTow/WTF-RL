...
base_path = "/nfs/nas4.irisa.fr/deepfakes/deepfakes/image_repurposing/multimodal-fake-news-detection/VisualNews/"
visual_news_path = base_path + "news_clippings/visual_news"
...
#     default=1e-7,
#     type=float,
#     help="The initial learning rate for the generator."
# )
...
#     default=1e-6,
#     type=float,
#     help="The initial learning rate for the discriminator."
# )
...
class TransformTrainer(Trainer):
    def compute_loss(self, model, inputs, return_outputs=False, is_eval=False):
        ...
        # print("Policy text {}".format(discriminator_inputs_text[:int(len(discriminator_inputs_text)/2)]))
        # print("GT text {}".format(["{}".format(discriminator_inputs_text[int(len(discriminator_inputs_text)/2):])]))
...
def main():
    ...
    # model.discriminator.resize_token_embeddings(len(tokenizer_clip))
